...
entanglement = "linear"
options = {
    "random_basis_layers": random_basis_layers,
    "single_qubit_gates": single_qubit_gates_measurement,
    "entanglement_gates": entanglement_gates_measurement,
...
random_natural_gradient_exp_values = optimizer_statevector.random_natural_gradient(
    eta=eta, basis="random", options=options
)
...
plt.plot(
    x_axis,
    vanilla_gradient_descent_exp_values,
    lw=2,
    linestyle="dashdot",
    color=tableau20[0],
